    ...
    return (
        <Card style={{ backgroundColor: '#d0e0f0', position: "relative", minHeight: "200px" }}>
            ...
            <CardActions style={{ position: 'absolute', bottom: 0 }}>
                <CustomButton handleClick={() => props.setComplete(props.todo.id)} variant="outlined" color="success" title="Done" />
                <CustomButton handleClick={() => props.deleteTask(props.todo.id)} variant="outlined" color="error" title="Delete" />
            </CardActions>
